    ...
    return ListView(children: [
      Padding(
        ...
        child: Container(decoration: BoxDecoration(
          ...
          child: Row(
            children: [
              Expanded(flex: MediaQuery.of(context).size.width<1000?7:8,
                child: Padding(
              ...
              Expanded(flex: MediaQuery.of(context).size.width<1000?3:2,child: Container(padding: EdgeInsets.only(left: 8,right: 8),
            ...
            if(snapshot.hasData){
              return Padding(
                ...
                child: PaginatedDataTable(
                  ...
                  rowsPerPage: snapshot.data.documents.length==0?1:snapshot.data.documents.length<10?snapshot.data.documents.length:10,
                  columns: [
  ...
  DataRow getRow(int index) {
    ...
    return DataRow.byIndex(selected: false,
      ...
      onSelectChanged: (value) {
        Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>OrderDetails(snapshot:row)));
      },
      cells: [
        DataCell(CircleAvatar(backgroundColor: Colors.white,child: row!=null?Container(
          width: 40,height: 40,
          child: ClipRRect(
        ...
        DataCell(Container(decoration: BoxDecoration(color: Colors.green.withOpacity(0.4),
            borderRadius: BorderRadius.circular(4)),
            padding: EdgeInsets.all(4),child: Text('${row.data['status']}',style: TextStyle(color: Colors.green),))
        ),
      ],
    );
  }
