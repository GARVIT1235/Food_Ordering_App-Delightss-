                                                                ...
                                                                <th class="small-12 large-12 columns first last">
                                                                    <table>
                                                                        <tr>
                                                                            <th>
                                                                                <center data-parsed="">
                                                                                    <h1> <b style="color:orange;"><center style="padding-top:20px;">DELIGHTSS</center></b> </h1>
                                                                                </center>
                                                                            </th>
                                                                            <th class="expander"></th>
                                                                        </tr>
                                                                            ...
                                                                            <table>
                                                                                <tr>
                                                                                    <th>
                                                                                        ...
                                                                                        <center data-parsed="">
                                                                                            <img src="https://icon-library.com/images/order-food-online-icon/order-food-online-icon-20.jpg" valign="bottom" align="center" width="500" height="200" class="text-center">
                                                                                        </center>
                                                                                    </th>
                                                                                    <th class="expander"></th>
                                                                                </tr>
                                                                                        ...
                                                                                        <th class="small-12 large-12 columns first last">
                                                                                            <table>
                                                                                                <tr>
                                                                                                    <th>
                                                                                                        <b><h5>Welcome!</h5></b>
                                                                                                        <p>Welcome to Delightss. You have successfully created your account. Please login through your credentials and order best food. Good food, happy you!!</p>
                                                                                                        <br>
                                                                                                        <!--<div class="button">
                                                                                                            <!--[if mso]>
                                                                ...
                                                                <table class="row grey"><tbody><tr>
                                                                            <th class="small-12 large-12 columns first last">
                                                                                <table>
                                                                                    <tr>
                                                                                        <th>
                                                                                            <p class="text-center footercopy">&#xA9; Copyright 2021 Delightss. All Rights Reserved.</p>
                                                                                        </th>
                                                                                        <th class="expander"></th>
                                                                                    </tr>
                                                                                </table>
