                                                                            ...
                                                                            <table class="row"><tbody><tr> <!-- main Email content -->
                                                                                        <th class="small-12 large-12 columns first last">
                                                                                            <table>
                                                                                                <tr>
                                                                                                    <th>
                                                                                                        <b><h5>Order Confirmation!</h5></b>
                                                                                                        <p>Name : $name <br> Adrress: $address<br>Email : $email<br>Phone: $phone <br> Thank You for Ordering the Items</p>
                                                                                                        <br>
                                                                                                        <!--<div class="button">
                                                                                                            <!--[if mso]>
